        ...
        <div className='min-h-screen relative bg-slate-50'>
            <div className='max-w-6xl mx-auto p-6'>
                ...
                <div className='mb-8'>
                    ...
                    <p className='text-slate-600'>Send and receive messages with your connections</p>
                </div>
                ...
                <div className='flex flex-col gap-3'>
                    {dummyConnectionsData.map((user) => (
                        <div key={user._id} className='max-w-xl flex flex-wrap gap-5 p-6 bg-white shadow rounded-md'>
                            <img src={user.profile_picture} alt="user-profile" className='rounded-full size-12 mx-auto'/>
